(function () {
 ...
 const CHALLENGE_KINDS = Object.freeze({ MASTER:'MASTER', SUPER:'SUPER', SHADOW:'SHADOW', LEGENDARY_TRIAL:'LEGENDARY_TRIAL', MYTHICAL_TRIAL:'MYTHICAL_TRIAL', TITANS_TRIAL:'TITANS_TRIAL', CELESTIAL_TRIAL:'CELESTIAL_TRIAL' });
 const STORAGE_KEY='campaign.progress', VERSION=1, TEAM_SIZE=3, START_SIZE=6, MAX_ROSTER=27, MAX_PROCESSED=96;
