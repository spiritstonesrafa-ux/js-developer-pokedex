...
- `UNSUPPORTED_STATUS`: Golpes sem dano direto (`status`), exceto os três explicitamente suportados na campanha: Poison Powder (#77), Will-O-Wisp (#261) e Thunder Wave (#86), apenas nos conjuntos fixos citados acima.
